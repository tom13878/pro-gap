...
oput_maze <- dplyr::select(oput_maze, -crop)
...
#   select(household_id, item_code=hh_s10q00, item_name=hh_s10q0a, qty=hh_s10q01
# )
...
# convert to hectacres
areas$area_gps <- areas$area*0.0001
