...
CS1 <- read_dta("C:/Users/Tomas/Documents/Work/LEI/NGA10_data.dta")
CS2 <- read_dta("C:/Users/Tomas/Documents/Work/LEI/NGA12_data.dta")

CS1$state <- as_factor(CS1$state)
CS2$state <- as_factor(CS2$state)
